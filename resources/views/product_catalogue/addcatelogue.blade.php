            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <form action="{{ url('efris/product-catalogue/store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6 mr-">
                                        <div class="form-group">
                                            <label for="title">Product Name<span class="text-red">*</span></label>
                                            <input id="title" type="number" class="form-control" placeholder="Product Name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="title">Product Code<span class="text-red">*</span></label>
                                            <select id="cat" name="isMainBranch" required="">
                                                <option value="24254">test1</option>
                                                {{-- @endforeach --}}

                                                <option value="246768">test2</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mr-">
                                        <div class="form-group">
                                            ...
                                            <select id="cat2" name="isMainBranch" required="">
