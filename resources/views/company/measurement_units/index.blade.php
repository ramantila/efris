...
@section('content')
            ...
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        ...
                        <span>List of measurement units</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card-header row">
                    <div class="col col-sm-2">
                        <button type="button" class="btn btn-sm btn-primary btn-rounded" data-toggle="modal"
                            data-target="#exampleModalCenter">Add measurement units</button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalCenterLabel">Add Measurement Units</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                </div>
                <form action="{{ url('efris/measurement-units/store') }}" method="POST">
                    @csrf
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="title">Measurement Units Name<span class="text-red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="title">Measurement Units Value<span class="text-red">*</span></label>
    ...
    {{-- ======================================== Edit Currency ================================================== --}}
    @foreach ($units as $index => $key)
        <div class="modal fade" id="setedit{{ $key['id'] }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterLabel">Edit Measurement Units</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <form action="{{ url('efris/measurement-units/update/' . $key['id']) }}" method="POST">
                        @csrf
                        <div class="modal-body">
    ...
    <div class="modal fade" id="delete{{ $key['id'] }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('efris/measurement-units/delete/' . $key['id']) }}" method="POST">
                        @csrf
                        <div class="modal-body">
