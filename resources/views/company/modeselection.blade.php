            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <form action="{{ url('companies/modeselections/') }}" method="POST">
                                @csrf
                                <div class="row">
                                    {{-- <div class="col-md-6 mr-"> --}}
                                        <div class="form-group">
                                            {{-- <label for="title1">Company Name<span class="text-red">*</span></label> --}}
                                            <input id="title1" hidden readonly type="text" value="{{ $company['id'] }}" class="form-control" name="company" placeholder="Company Name" required>
