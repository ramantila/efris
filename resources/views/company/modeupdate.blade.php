            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#">Mode Selection Update</a>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <form action="{{ url('companies/modeselectionsecond/'.$id) }}" method="POST">
                                @csrf
                                <div class="row">
                                    {{-- <div class="col-md-6 mr-"> --}}
                                        <div class="form-group">
                                            {{-- <label for="title1">Company Name<span class="text-red">*</span></label> --}}
                                            <input id="title1" type="text" hidden value="{{ $company['id'] }}" class="form-control" name="company" placeholder="Company Name" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="title">Device Number<span class="text-red">*</span></label>
                                            <input id="title1" type="text"   class="form-control" name="deviceNumber" placeholder="Device Number" required>
